...
const debug = debug__default['default']('botium-connector-echo');
const Capabilities = {
...
if (fs__default['default'].existsSync(path__default['default'].join(__dirname, audioFile))) {
  audioBuffer = Buffer.from(fs__default['default'].readFileSync(path__default['default'].join(__dirname, audioFile)));
} else if (fs__default['default'].existsSync(path__default['default'].join(__dirname, '..', audioFile))) {
  audioBuffer = Buffer.from(fs__default['default'].readFileSync(path__default['default'].join(__dirname, '..', audioFile)));
}
...
if (fs__default['default'].existsSync(path__default['default'].join(__dirname, videoFile))) {
  videoBuffer = Buffer.from(fs__default['default'].readFileSync(path__default['default'].join(__dirname, videoFile)));
} else if (fs__default['default'].existsSync(path__default['default'].join(__dirname, '..', videoFile))) {
  videoBuffer = Buffer.from(fs__default['default'].readFileSync(path__default['default'].join(__dirname, '..', videoFile)));
}
...
class BotiumConnectorEcho {
  ...
  Build() {
    if (this.caps[Capabilities.ECHO_ANSWERS]) {
      const extraAnswers = lodash__default['default'].isString(this.caps[Capabilities.ECHO_ANSWERS]) ? JSON.parse(this.caps[Capabilities.ECHO_ANSWERS]) : this.caps[Capabilities.ECHO_ANSWERS];
      this.answers = this.answers.concat(extraAnswers);

      for (const a of this.answers) {
        if (lodash__default['default'].isString(a.input)) a.input = [a.input];
      }
    }

    if (this.caps[Capabilities.ECHO_WELCOMEMESSAGE]) {
      const extraWelcomeMessages = lodash__default['default'].isString(this.caps[Capabilities.ECHO_WELCOMEMESSAGE]) ? JSON.parse(this.caps[Capabilities.ECHO_WELCOMEMESSAGE]) : this.caps[Capabilities.ECHO_WELCOMEMESSAGE];
  ...
  Start() {
    ...
    for (const welcomeMessage of this.welcomeMessages) {
      ...
      if (lodash__default['default'].isString(welcomeMessage)) {
        botMsg.messageText = welcomeMessage;
      } else if (lodash__default['default'].isFunction(welcomeMessage.output)) {
        botMsg = Object.assign(botMsg, welcomeMessage.output({}, this.session));
      } else if (lodash__default['default'].isString(welcomeMessage.output)) {
  ...
  UserSays(msg) {
    ...
    if (template && template.output) {
      if (lodash__default['default'].isFunction(template.output)) {
        botMsg = Object.assign(botMsg, template.output(msg, this.session));
      } else if (lodash__default['default'].isString(template.output)) {
      ...
      const mediaName = decodeURIComponent(path__default['default'].basename(media.downloadUri || media.mediaUri) || '-');
...
var botiumConnectorEcho_1 = botiumConnectorEcho.PluginVersion;
var botiumConnectorEcho_2 = botiumConnectorEcho.PluginClass;
var botiumConnectorEcho_3 = botiumConnectorEcho.Import;
var botiumConnectorEcho_4 = botiumConnectorEcho.Export;
var botiumConnectorEcho_5 = botiumConnectorEcho.PluginDesc;

exports.Export = botiumConnectorEcho_4;
exports.Import = botiumConnectorEcho_3;
exports.PluginClass = botiumConnectorEcho_2;
exports.PluginDesc = botiumConnectorEcho_5;
exports.PluginVersion = botiumConnectorEcho_1;
exports['default'] = botiumConnectorEcho;
//# sourceMappingURL=botium-connector-echo-cjs.js.map
